...
public class DataParser {
	...
	public ArrayList<Result> search(String query, String base) {
		try {
			...
			saxParser.parse("plugins/SearchIds/" + SearchIds.dataXml, handler);
	...
	class DataHandler extends DefaultHandler {
		...
		public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
			...
			if (qName.equalsIgnoreCase("ITEM")) {
				...
				if (SearchIds.searchType.equalsIgnoreCase("all") || (SearchIds.searchType.equalsIgnoreCase("blocks") && blocks == true) || (SearchIds.searchType.equalsIgnoreCase("items") && items == true)) {
